...
var createObject = function createObject(objectArray, ParticleObject, particleMax) {
  for (var i = 0; i < particleMax; i += 1) {
    var particleObject = new ParticleObject();
...
var drawTree = function drawTree(treeObject) {
...
var drawDust = function drawDust(dustObject) {
  context.save(); // Running this before it's draw to determine opacity
...
var moveTree = function moveTree(treeObject) {
...
var moveDust = function moveDust(dustObject) {
...
function blink(i) {
  ...
  timeout = setTimeout(function () {
    if (i < selectedText.length) {
      $("#b".concat(selectedText[i]))[0].children[BulbElement].style.fill = BulbDefaultColor;
...
function showLetters() {
  if (index < selectedText.length) {
    $("#b".concat(selectedText[index]))[0].children[BulbElement].style.fill = BulbColor[selectedText[index].toUpperCase()];
    blink(index);
...
function inputAnimation() {
  ...
  $("#i_text").on("blur", function () {
    $(_this).parent().removeClass("is-focus is-type");
  });
  $("#i_text").on("keydown", function (event) {
    $(this).parent().addClass("is-type");

    if (event.which === 8 && $(this).val() === "") {
      $(this).parent().removeClass("is-type");
    }
  });
} // Paralax
...
function parallaxScroll() {
  ...
  $("#parallax-lvl-0").css("top", "".concat(0 - scrolled * 0.25, "px"));
  $("#parallax-lvl-1").css("top", "".concat(0 - scrolled * 0.5, "px"));
  $("#parallax-lvl-2").css("top", "".concat(0 - scrolled * 0.75, "px"));
  $("#parallax-lvl-3").css("top", "".concat(0 - scrolled * 0.9, "px"));
}
/* ---------------------------------------------
		Height 100%
		--------------------------------------------- */
...
(function () {
  ...
  var Confetti = function () {
    function Confetti() {
      ...
      this.rgb = "rgba(".concat(this.style[0], ",").concat(this.style[1], ",").concat(this.style[2]);
      this.r = ~~range(2, 6);
      this.r2 = 2 * this.r;
      this.replace();
    }
    ...
    Confetti.prototype.draw = function () {
      ...
      return drawCircle(~~this.x, ~~this.y, this.r, "".concat(this.rgb, ",").concat(this.opacity, ")"));
    };
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/site.js"], null)
