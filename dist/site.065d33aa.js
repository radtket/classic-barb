...
function blink(i) {
  ...
  timeout = setTimeout(function () {
    if (i < selectedText.length) {
      (0, _jquery.default)("#b".concat(selectedText[i]))[0].children[BulbElement].style.fill = BulbDefaultColor;
...
function showLetters() {
  if (index < selectedText.length) {
    (0, _jquery.default)("#b".concat(selectedText[index]))[0].children[BulbElement].style.fill = BulbColor[selectedText[index].toUpperCase()];
    blink(index);
